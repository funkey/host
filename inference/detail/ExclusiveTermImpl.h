...
public:
	...
	double constant() {
		...
		constant += _lambdas[_edge1Selected ? Edge1Value1() : Edge1Value0()];
		constant += _lambdas[_edge2Selected ? Edge2Value1() : Edge2Value0()];
